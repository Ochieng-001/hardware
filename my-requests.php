        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="assistance.php" class="btn btn-primary me-2">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <strong>Type:</strong> <?php echo htmlspecialchars($ticket['assistance_type'] ?? 'General'); ?><br>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <strong>Assigned To:</strong> <?php echo $ticket['assigned_to_name'] ?: 'Not assigned'; ?><br>
                                                            <?php if ($ticket['scheduled_date']): ?>
                                                            <strong>Scheduled:</strong> <?php echo date('M d, Y', strtotime($ticket['scheduled_date'])); ?>
                                                    ...
                                                    <?php echo htmlspecialchars($ticket['title']); ?><br><br>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <strong>Equipment:</strong> <?php echo htmlspecialchars($request['equipment_name']); ?><br>
                                                            <?php if ($request['model']): ?>
                                                            <strong>Model:</strong> <?php echo htmlspecialchars($request['model']); ?><br>
                                                            <?php endif; ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <strong>From:</strong> <?php echo date('M d, Y', strtotime($request['requested_from'])); ?><br>
                                                            <strong>To:</strong> <?php echo date('M d, Y', strtotime($request['requested_to'])); ?><br>
                                                            <strong>Created:</strong> <?php echo date('M d, Y H:i', strtotime($request['created_at'])); ?><br>
                                                            <?php if ($request['approved_by_name']): ?>
                                                            <strong>Approved By:</strong> <?php echo htmlspecialchars($request['approved_by_name']); ?><br>
                                                            <?php endif; ?>
                                                            <?php if ($request['due_date']): ?>
                                                            <strong>Due Date:</strong> <?php echo date('M d, Y', strtotime($request['due_date'])); ?><br>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    <hr>
